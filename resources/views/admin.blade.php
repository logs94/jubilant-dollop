...
<body>
<div class="wrapper">
    <div class="logo"><img src="https://www.freepnglogos.com/uploads/censored-png/censorship-png-35.png"
                           alt="censorship png"/></div>
    <div class="text-center mt-4 name"> BO$$</div>
    <form class="p-3 mt-3" method="post" action="{{route('admin')}}">
        @csrf
